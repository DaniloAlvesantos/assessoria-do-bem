...
export const Requirements = () => {
  const requirements = [
    {
      icon: <Building className="w-12 h-12 text-app-blue" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-app-blue to-app-blue-light rounded-2xl p-8 text-white">
            ...
            <a
              href="#contato"
              className="bg-white text-gray-900 px-8 py-4 rounded-lg text-lg font-poppins font-semibold hover:bg-gray-100 transition-colors inline-flex items-center"
            >
